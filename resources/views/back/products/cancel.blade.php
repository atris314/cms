...
<section >
    <section class="content-header">
        <h1>
           سفارشات حذف شده توسط کاربر

        </h1>
        <ol class="breadcrumb">
            <li><a href="{{route('admin')}}"><i class="fa fa-dashboard"></i> خانه</a></li>
            <li><a href="#">سفارشات حذف شده</a></li>
    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="box" style="padding: 30px ">
                <form action="{{route('cancelSearch')}}" method="get">
                    @csrf
...
{{--                            <input type="text" class="form-control" placeholder="عبارت مورد جستجو ..." name="title" value="{{old('title')}}" >--}}
        ...
        <div class="col-xs-4">
            <div class="box" style="padding: 30px ">
                <form action="{{route('cancelCodeSearch')}}" method="get">
                    @csrf
        ...
        <div class="col-xs-4">
            <div class="box" style="padding: 30px ">
                <form action="{{route('canceluserCodeSearch')}}" method="get">
                    @csrf
                                    ...
                                    <td class="text-center">
                                        ...
                                        @elseif($product['status']==4)
                                            ...
                                            @elseif($product->status==14)
                                                <a  class="label pull-center bg-olive" >سفارش حاضر است</a>
