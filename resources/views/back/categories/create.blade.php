    ...
    <div class="col-md-10 offset-md-1 justify-content-md-center">
        <div class="box box-warning col-md-10 offset-md-1">
            <div class="box-header with-border">
                <h3 class="box-title">ایجاد دسته بندي جدید</h3>
            </div>
            @include('back.massages')
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('back.categories.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category_id" style="font-family: 'Vazir';">
                            <option value="0">---</option>
                            @foreach($cattop as $key=> $value)
