...
{{--                                </th>--}}
                            ...
                            @foreach($payments as $payment)
                                <tr role="row" class="odd">
                                    <td class="sorting_1"><a href="{{route('back.payments.show',$payment->id)}}">@if($payment->product){{$payment->product->codepro}} @endif</a></td>
                                    ...
                                    <td>@if($payment->order){{$payment->order->desc}}@endif</td>
                                    <td>{{$payment->order_id}}</td>
                                        ...
                                        <td>
                                        <a class=" label pull-center bg-aqua" href="{{route('back.payments.show',$payment->id)}}">نمایش</a>
                                    </td>
                                </tr>
                            @endforeach
                           </tbody>
