                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="box-header">
                            <h3 class="box-title">لیست نمونه سفارشات</h3>
                        </div>
                    </div>
                    <div class="col-lg-3">
            ...
            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                            ...
                            @foreach($portfolios as $prtfolio)
                                <tr role="row" class="odd">
                                    ...
                                    @endif
                                    <td class="sorting_1"><a href="{{route('back.portfolios.edit',$prtfolio->id)}}">{!! mb_substr($prtfolio->name,0,10).'..'!!} </a></td>
                                    <td>{{$prtfolio->tag}}</td>
                                    <td>{{$prtfolio->link}}</td>
                                    <td>{!! mb_substr($prtfolio->description,0,80).'..'!!}</td>
                                    <td>{{$prtfolio->title}}</td>
                                    <td>{!! mb_substr($prtfolio->body,0,60).'..'!!}</td>
