...
@section('content')
    ...
    <div class="col-md-10 offset-md-1 justify-content-md-center">
        <div class="box box-warning col-md-10 offset-md-1">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('back.slideshows.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">alt تصویر: </label>
                        <input type="text" class="form-control @error('alt') is-invalid @enderror" id="exampleInputEmail1" name="alt" value="{{old('alt')}}" placeholder="alt">
                    </div>
                    <div class="form-group">
