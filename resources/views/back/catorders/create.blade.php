...
@section('content')
    ...
    <div class="col-md-10 offset-md-1 justify-content-md-center">
        <div class="box box-warning col-md-10 offset-md-1">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('back.catorders.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="catorder_id" style="font-family: 'Vazir';">
                            <option value="0">---</option>
                            @foreach($catorderstop as $key=> $value)
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status" >
                            <option value="0">منتشر شود</option>
                            <option value="1">منتشر نشود</option>
                        </select>
                    </div>
                    <div class="form-group">
