                ...
                <form role="form" action="{{route('back.catorders.update',$catorder->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('color') is-invalid @enderror" id="exampleInputEmail1" name="color" value="{{$catorder->color}}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">وضعيت:</label>
                            <select class="form-control" name="status" >
                                <option value="1">منتشر نشود</option>
                                <option value="0"  <?php if($catorder->status==1) echo 'selected' ; ?>>منتشر شود</option>
                            </select>
                        </div>
                        <div class="form-group">
