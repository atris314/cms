    ...
    <div class="col-md-10 offset-md-1 justify-content-md-center">
        <div class="box box-warning col-md-10 offset-md-1">
            <div class="box-header with-border">
                <h3 class="box-title">ایجاد تیکت</h3>
            </div>
            @include('back.massages')
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('back.tickets.store')}}" method="post">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <lable for="exampleInputEmail1"> پیام:</lable>
                        <textarea id="editor" type="text" class="form-control @error('message') is-invalid @enderror" name="message" style="font-family: 'vazir';" >{{old('message')}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">اولویت:</label>
